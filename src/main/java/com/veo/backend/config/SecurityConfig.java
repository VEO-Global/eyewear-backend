    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.cors(Customizer.withDefaults())
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/payments/payos/return", "/api/payments/payos/cancel").permitAll()
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/payments/order/*/qr", "/api/payments/order/*/status", "/api/payments/my-history", "/api/payments/payos/stream/customer").hasRole("CUSTOMER")
                        .requestMatchers(HttpMethod.POST, "/api/payments/payos/confirm").hasRole("CUSTOMER")
                        .requestMatchers(HttpMethod.GET, "/api/payments/payos/pending", "/api/payments/payos/stream/staff", "/api/payments/user/*", "/api/payments/all").hasAnyRole("SALES", "MANAGER", "ADMIN")
                        .requestMatchers(HttpMethod.POST, "/api/payments/order/*/confirm", "/api/payments/payos/approve", "/api/payments/payos/reject").hasAnyRole("SALES", "MANAGER", "ADMIN")
                        .requestMatchers("/api/operation/**", "/api/operaion/**").hasAnyRole("OPERATIONS", "MANAGER", "ADMIN")
